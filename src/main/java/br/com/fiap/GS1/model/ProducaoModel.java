...
public class ProducaoModel {
	...
	public ProducaoModel(long id, long ano, long quantidade) {
		super();
		this.id = id;
		this.ano = ano;
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PRODUCAO_SEQ")
	@SequenceGenerator(name = "PRODUCAO_SEQ", sequenceName = "PRODUCAO_SEQ", allocationSize = 1)
	public long getId() {
		return id;
	}
