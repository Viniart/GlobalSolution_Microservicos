			...
			<div class="col-lg-12">
				<div class="well">
					...
					<div class="form-group">
						<label class="control-label" for="nome">Ano:</label> <b>${producao.ano}</b>
					</div>

					<div class="form-group">
						<label class="control-label" for="nome">Cultura:</label> <label
							class="label label-default">${producao.cultura.nomeCultura}</label>
					</div>

					<div class="form-group">
						<label class="control-label" for="mensagem">Quantidade Produzida:</label> <label
							class="label label-default">${producao.quantidade}</label>
					</div>
